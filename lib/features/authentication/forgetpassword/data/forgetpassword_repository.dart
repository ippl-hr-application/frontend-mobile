...
abstract class ForgetpasswordRepository {
  factory ForgetpasswordRepository(Dio dio, {String? baseUrl}) = _ForgetpasswordRepository;

  @POST('/auth/employee-forgot-password')
  Future<ForgetpasswordResponse> forgetpassword(@Body() ForgetpasswordRequest data);
}
