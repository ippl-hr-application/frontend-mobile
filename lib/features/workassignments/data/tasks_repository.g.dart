...
class _TasksRepository implements TasksRepository {
  _TasksRepository(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<TasksHistory> getTasksHistory(String companyId) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TasksHistory>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TasksHistory.fromJson(_result.data!);
    return value;
  }
